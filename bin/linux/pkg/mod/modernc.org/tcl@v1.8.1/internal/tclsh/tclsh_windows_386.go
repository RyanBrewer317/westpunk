...
type Tcl_StatBuf = _stati64 /* tcl.h:446:26 */
...
func main(tls *libc.TLS, argc int32, dummy uintptr) int32 { /* tclAppInit.c:88:1: */
	...
	*(*int32)(unsafe.Pointer(bp)) = argc
	...
	setargv(tls, bp /* &argc */, bp+4 /* &argv */)

	// Forward slashes substituted for backslashes.

	for p = *(*uintptr)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 4 /* argv */)) + uintptr(0)*4)); int32(*(*TCHAR)(unsafe.Pointer(p))) != 0; p += 2 {
		if int32(*(*TCHAR)(unsafe.Pointer(p))) == '\\' {
			*(*TCHAR)(unsafe.Pointer(p)) = TCHAR('/')
		}
	}

	tcl.XTcl_MainExW(tls, *(*int32)(unsafe.Pointer(bp /* argc */)), *(*uintptr)(unsafe.Pointer(bp + 4 /* argv */)), *(*uintptr)(unsafe.Pointer(&struct {
