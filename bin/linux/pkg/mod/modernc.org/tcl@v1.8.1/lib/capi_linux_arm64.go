// Code generated by 'ccgo -D__printf__=printf -export-defines  -export-enums  -export-externs X -export-fields F -export-structs  -export-typedefs  -hide TclpCreateProcess -lmodernc.org/z/lib -o lib/tcl_linux_arm64.go -pkgname tcl -replace-fd-zero __ccgo_fd_zero -replace-tcl-default-double-rounding __ccgo_tcl_default_double_rounding -replace-tcl-ieee-double-rounding __ccgo_tcl_ieee_double_rounding -trace-translation-units /tmp/go-generate-3777966171/cdb.json libtcl8.6.a libtclstub8.6.a', DO NOT EDIT.
