// Code generated by 'ccgo -lmodernc.org/z/lib -o internal/example_linux_386.go -trace-translation-units /tmp/go-generate-515242649/cdb.json example64', DO NOT EDIT.
...
func test_compress(tls *libc.TLS, compr uintptr, comprLen uLong, uncompr uintptr, uncomprLen uLong) { /* example.c:88:6: */
	...
	*(*uLong)(unsafe.Pointer(bp + 44)) = uncomprLen
	...
	{
		if err != 0 {
			libc.Xfprintf(tls, libc.Xstderr, ts+20 /* "%s error: %d\n" */, libc.VaList(bp, ts+34 /* "compress" */, err))
			libc.Xexit(tls, 1)
		}
	}
	...
	if libc.Xstrcmp(tls, uncompr, uintptr(unsafe.Pointer(&hello))) != 0 {
		libc.Xfprintf(tls, libc.Xstderr, ts+62 /* "bad uncompress\n" */, 0)
		libc.Xexit(tls, 1)
	} else {
...
func test_gzio(tls *libc.TLS, fname uintptr, uncompr uintptr, uncomprLen uLong) { /* example.c:114:6: */
	...
	file = z.Xgzopen64(tls, fname, ts+96 /* "wb" */)
	if file == (uintptr(0)) {
		libc.Xfprintf(tls, libc.Xstderr, ts+99 /* "gzopen error\n" */, 0)
		libc.Xexit(tls, 1)
	}
	z.Xgzputc(tls, file, 'h')
	if z.Xgzputs(tls, file, ts+113 /* "ello" */) != 4 {
		libc.Xfprintf(tls, libc.Xstderr, ts+118 /* "gzputs err: %s\n" */, libc.VaList(bp, z.Xgzerror(tls, file, bp+80 /* &err */)))
		libc.Xexit(tls, 1)
	}
	if z.Xgzprintf(tls, file, ts+134 /* ", %s!" */, libc.VaList(bp+8, ts+14 /* "hello" */)) != 8 {
		libc.Xfprintf(tls, libc.Xstderr, ts+140 /* "gzprintf err: %s..." */, libc.VaList(bp+16, z.Xgzerror(tls, file, bp+80 /* &err */)))
		libc.Xexit(tls, 1)
	}
	z.Xgzseek64(tls, file, int64(1), 1) // add one zero byte
	z.Xgzclose(tls, file)

	file = z.Xgzopen64(tls, fname, ts+158 /* "rb" */)
	if file == (uintptr(0)) {
		libc.Xfprintf(tls, libc.Xstderr, ts+99 /* "gzopen error\n" */, 0)
		libc.Xexit(tls, 1)
	}
	...
	if z.Xgzread(tls, file, uncompr, uint32(uncomprLen)) != len {
		libc.Xfprintf(tls, libc.Xstderr, ts+161 /* "gzread err: %s\n" */, libc.VaList(bp+24, z.Xgzerror(tls, file, bp+80 /* &err */)))
		libc.Xexit(tls, 1)
	}
	if libc.Xstrcmp(tls, uncompr, uintptr(unsafe.Pointer(&hello))) != 0 {
		libc.Xfprintf(tls, libc.Xstderr, ts+177 /* "bad gzread: %s\n" */, libc.VaList(bp+32, uncompr))
		libc.Xexit(tls, 1)
	} else {
		libc.Xprintf(tls, ts+193 /* "gzread(): %s\n" */, libc.VaList(bp+40, uncompr))
	}

	pos = z.Xgzseek64(tls, file, int64(-8), 1)
	if (pos != int64(6)) || (z.Xgztell64(tls, file) != pos) {
		libc.Xfprintf(tls, libc.Xstderr, ts+207, /* "gzseek error, po..." */
			libc.VaList(bp+48, int32(pos), int32(z.Xgztell64(tls, file))))
		libc.Xexit(tls, 1)
	}
	...
	if (func() int32 {
		...
		libc.Xfprintf(tls, libc.Xstderr, ts+242 /* "gzgetc error\n" */, 0)
		libc.Xexit(tls, 1)
	}

	if z.Xgzungetc(tls, ' ', file) != ' ' {
		libc.Xfprintf(tls, libc.Xstderr, ts+256 /* "gzungetc error\n" */, 0)
		libc.Xexit(tls, 1)
	}

	z.Xgzgets(tls, file, uncompr, int32(uncomprLen))
	if libc.Xstrlen(tls, uncompr) != size_t(7) { // " hello!"
		libc.Xfprintf(tls, libc.Xstderr, ts+272 /* "gzgets err after..." */, libc.VaList(bp+64, z.Xgzerror(tls, file, bp+80 /* &err */)))
		libc.Xexit(tls, 1)
	}
	if libc.Xstrcmp(tls, uncompr, (uintptr(unsafe.Pointer(&hello))+uintptr(6))) != 0 {
		libc.Xfprintf(tls, libc.Xstderr, ts+301 /* "bad gzgets after..." */, 0)
		libc.Xexit(tls, 1)
	} else {
...
func test_deflate(tls *libc.TLS, compr uintptr, comprLen uLong) { /* example.c:200:6: */
	...
	// var c_stream z_stream at bp+64, 56
	// compression stream
	var err int32
	var len uLong = (uLong(libc.Xstrlen(tls, uintptr(unsafe.Pointer(&hello)))) + uLong(1))
	...
	for ((*z_stream)(unsafe.Pointer(bp+64 /* &c_stream */)).total_in != len) && ((*z_stream)(unsafe.Pointer(bp+64 /* &c_stream */)).total_out < comprLen) {
		(*z_stream)(unsafe.Pointer(bp + 64 /* &c_stream */)).avail_in = libc.AssignPtrUint32(bp+64 /* &c_stream */ +16 /* &.avail_out */, uInt(1)) // force small buffers
...
func test_inflate(tls *libc.TLS, compr uintptr, comprLen uLong, uncompr uintptr, uncomprLen uLong) { /* example.c:238:6: */
	...
	var err int32
	// var d_stream z_stream at bp+56, 56
	...
	for ((*z_stream)(unsafe.Pointer(bp+56 /* &d_stream */)).total_out < uncomprLen) && ((*z_stream)(unsafe.Pointer(bp+56 /* &d_stream */)).total_in < comprLen) {
		(*z_stream)(unsafe.Pointer(bp + 56 /* &d_stream */)).avail_in = libc.AssignPtrUint32(bp+56 /* &d_stream */ +16 /* &.avail_out */, uInt(1)) // force small buffers
	...
	if libc.Xstrcmp(tls, uncompr, uintptr(unsafe.Pointer(&hello))) != 0 {
		libc.Xfprintf(tls, libc.Xstderr, ts+422 /* "bad inflate\n" */, 0)
		libc.Xexit(tls, 1)
	} else {
...
func test_large_deflate(tls *libc.TLS, compr uintptr, comprLen uLong, uncompr uintptr, uncomprLen uLong) { /* example.c:279:6: */
	...
	// var c_stream z_stream at bp+80, 56
	// compression stream
	var err int32
	...
	if (*z_stream)(unsafe.Pointer(bp+80 /* &c_stream */)).avail_in != uInt(0) {
		libc.Xfprintf(tls, libc.Xstderr, ts+450 /* "deflate not gree..." */, 0)
		libc.Xexit(tls, 1)
	}
	...
	if err != 1 {
		libc.Xfprintf(tls, libc.Xstderr, ts+470 /* "deflate should r..." */, 0)
		libc.Xexit(tls, 1)
	}
...
func test_large_inflate(tls *libc.TLS, compr uintptr, comprLen uLong, uncompr uintptr, uncomprLen uLong) { /* example.c:334:6: */
	...
	if (*z_stream)(unsafe.Pointer(bp+56 /* &d_stream */)).total_out != ((uLong(2) * uncomprLen) + (comprLen / uLong(2))) {
		libc.Xfprintf(tls, libc.Xstderr, ts+520 /* "bad large inflat..." */, libc.VaList(bp+48, (*z_stream)(unsafe.Pointer(bp+56 /* &d_stream */)).total_out))
		libc.Xexit(tls, 1)
	} else {
...
func test_flush(tls *libc.TLS, compr uintptr, comprLen uintptr) { /* example.c:375:6: */
	...
	// compression stream
	var err int32
	var len uInt = (libc.Xstrlen(tls, uintptr(unsafe.Pointer(&hello))) + uInt(1))
...
func test_sync(tls *libc.TLS, compr uintptr, comprLen uLong, uncompr uintptr, uncomprLen uLong) { /* example.c:413:6: */
	...
	var err int32
	// var d_stream z_stream at bp+72, 56
	// decompression stream
	...
	if err != (-3) {
		libc.Xfprintf(tls, libc.Xstderr, ts+577 /* "inflate should r..." */, 0)
...
func test_dict_deflate(tls *libc.TLS, compr uintptr, comprLen uLong) { /* example.c:457:6: */
	...
	// var c_stream z_stream at bp+48, 56
	// compression stream
	var err int32
	...
	(*z_stream)(unsafe.Pointer(bp + 48 /* &c_stream */)).avail_in = (libc.Xstrlen(tls, uintptr(unsafe.Pointer(&hello))) + uInt(1))
...
func test_dict_inflate(tls *libc.TLS, compr uintptr, comprLen uLong, uncompr uintptr, uncomprLen uLong) { /* example.c:494:6: */
	...
	for {
		...
		if err == 2 {
			if (*z_stream)(unsafe.Pointer(bp+56 /* &d_stream */)).adler != dictId {
				libc.Xfprintf(tls, libc.Xstderr, ts+660 /* "unexpected dicti..." */, 0)
				libc.Xexit(tls, 1)
			}
	...
	if libc.Xstrcmp(tls, uncompr, uintptr(unsafe.Pointer(&hello))) != 0 {
		libc.Xfprintf(tls, libc.Xstderr, ts+700 /* "bad inflate with..." */, 0)
		libc.Xexit(tls, 1)
	} else {
...
func main1(tls *libc.TLS, argc int32, argv uintptr) int32 { /* example.c:545:5: */
	...
	var compr uintptr
	var uncompr uintptr
	*(*uLong)(unsafe.Pointer(bp + 24 /* comprLen */)) = (uint32(10000) * uint32(unsafe.Sizeof(int32(0)))) // don't overflow on MSDOS
	...
	if int32(*(*int8)(unsafe.Pointer(z.XzlibVersion(tls)))) != int32(*(*int8)(unsafe.Pointer(myVersion))) {
		libc.Xfprintf(tls, libc.Xstderr, ts+752 /* "incompatible zli..." */, 0)
		libc.Xexit(tls, 1)

	} else if libc.Xstrcmp(tls, z.XzlibVersion(tls), ts+353 /* "1.2.11" */) != 0 {
		libc.Xfprintf(tls, libc.Xstderr, ts+779 /* "warning: differe..." */, 0)
	}

	libc.Xprintf(tls, ts+812, /* "zlib version %s ..." */
		libc.VaList(bp, ts+353 /* "1.2.11" */, 0x12b0, z.XzlibCompileFlags(tls)))

	compr = libc.Xcalloc(tls, uInt(*(*uLong)(unsafe.Pointer(bp + 24 /* comprLen */))), uint32(1))
	uncompr = libc.Xcalloc(tls, uInt(uncomprLen), uint32(1))
	...
	test_gzio(tls, func() uintptr {
		if argc > 1 {
			return *(*uintptr)(unsafe.Pointer(argv + 1*4))
		}
